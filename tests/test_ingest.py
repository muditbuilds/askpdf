...
class TestIngest:
    ...
    def test_ingests_pdf_and_stores_chunks(
        self, mock_chunk_pdf, mock_get_embeddings, mock_insert_chunk
    ):
    ...
    def test_uses_pdf_path_as_source(
        ...
        from ingest import ingest
        ingest(mock_conn, "/path/to/my/document.pdf")
